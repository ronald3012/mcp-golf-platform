...
exports.deleteFoursomeTool = void 0;
const zod_1 = require("zod");
const apiClient_js_1 = require("../apiClient.js");
const inputSchema = {
    id: zod_1.z.number().int().positive().describe("ID del foursome a eliminar."),
    confirm: zod_1.z
        .boolean()
        .optional()
        .describe("Set en true SOLO si el humano ya confirmó que está OK perder los posteos asociados. " +
...
//# sourceMappingURL=deleteFoursome.js.map